...
public class Q6P2 {
	...
	public static void main (String args[]) {
		...
		try {
			...
			BufferedReader readTagModel = new BufferedReader(new FileReader("experimental_tagger.model"));
			...
			printBestHistories(bestHistories, "tag_dev_experimental.out");
		...
		for (String sentence : devSentences) {
			...
			for (String history: historyOptions) {
				...
				for (String prefix : prefixes) {
					...
					Double feature4 = vWeights.get(prefixKey);
					if (feature4 == null) {
						feature4 = 0.0;
					}
					prefixSum += feature4;
				...
				Double feature5 = vWeights.get(dashKey);
				if (feature5 == null) {
					feature5 = 0.0;
				}
				...
				Double feature6 = vWeights.get(capKey);
				if (feature6 == null) {
					feature6 = 0.0;
				}
				
				Double historyWeight = feature1 + feature2 + suffixSum + prefixSum + feature5 + feature6;
