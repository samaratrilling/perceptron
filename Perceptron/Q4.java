...
public class Q4 {
	...
	public static void main (String args[]) {
		...
		try {
			...
			bestHistories = perceptron(rWords, tags, vWeights, devSentences, taggerHistory, taggerDecoder);
	...
	public static String perceptron(HashSet<String> rWords, HashSet<String> tags,
			HashMap<String, Double> vWeights, List<String> devSentences, Process taggerHistory, Process taggerDecoder)
			throws IOException{
	...
	public static void storeRAndV(String line) {
		...
		if (featureStringComp[0].equals("TAG")) {
			rWords.add(featureStringComp[1]);
		}
		if (featureStringComp[0].equals("BIGRAM")) {
			tags.add(featureStringComp[1]);
			tags.add(featureStringComp[2]);
